  ...
  const packs = [
    {
      name: "Bronze Package",
      price: "500 AED",
      features: ["1 hour photography session", "2 outfit changes", "20 edited images"],
      badge: "",
      style: "bg-white",
    },
    {
      name: "Silver Package",
      price: "600 AED",
      features: ["2 hours photography session", "5 outfit changes", "50 edited images"],
      badge: "Most Popular",
      style: "bg-white",
    },
    {
      name: "Gold Package",
      price: "750 AED",
      features: ["3 hours photography session", "6 outfit changes", "100 edited images"],
